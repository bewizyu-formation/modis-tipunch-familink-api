...
public class ContactForm {
	...
	public ContactForm(int idContact, String nom, String prenom, String gravatar, String numTel, String adresse, String codePostal,
			String ville, String email, Profil profil, Integer idProfil) {
		super();
	...
	/**
	 * @param listeFavorisContact the listeFavorisContact to set
	 */
